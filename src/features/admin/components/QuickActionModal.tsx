        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
                <motion.div
                    ...
                    className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto hide-scrollbar rounded-3xl border border-slate-200 bg-white p-6 sm:p-8 shadow-2xl font-sans"
                >
                    {/* Top Bar */}
