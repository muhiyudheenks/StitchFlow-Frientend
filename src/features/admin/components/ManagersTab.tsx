...
import { FiUsers, FiCheckSquare, FiAward, FiPlus, FiSend, FiUserCheck } from 'react-icons/fi';
                            ...
                            >
                                <div>
                                    ...
                                    <div className="flex items-center justify-between pb-6 border-b border-slate-100 dark:border-slate-800 mb-6">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-xs text-slate-500 dark:text-slate-400">{mgr.department || 'Management'}</p>
                                            </div>
                                        </div>
                                    ...
                                    <div className="mb-6 p-4 rounded-2xl bg-slate-50/80 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-800">
                                        ...
                                        <p className="text-sm font-bold text-slate-900 dark:text-slate-100 mt-0.5">
                                            {mgr.designation || 'Shift Manager'} ({mgr.department || 'Production'})
                                        </p>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-3 gap-3 mb-6">
                                        <div className="p-3 rounded-2xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-800 text-center">
                                            ...
                                            <span className="text-[10px] text-slate-400 dark:text-slate-500 block">Verified: {isVerified ? 'Yes' : 'No'}</span>
                                        </div>
                                        ...
                                        <div className="p-3 rounded-2xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-800 text-center">
                                            ...
                                            <span className="text-xs font-extrabold text-slate-900 dark:text-slate-100 capitalize block">{mgr.role}</span>
                                            <span className="text-[10px] text-slate-400 dark:text-slate-500 block">Supervisor</span>
                                        </div>
                                        ...
                                        <div className="p-3 rounded-2xl border border-slate-100 dark:border-slate-800 bg-white dark:bg-slate-800 text-center">
                                            ...
                                            <span className="text-xs font-extrabold text-purple-700 dark:text-purple-400 uppercase block">{mgr.isBlock ? 'Blocked' : 'Active'}</span>
                                ...
                                <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between gap-3">
                                    ...
                                    <button
                                        ...
                                        className="flex-1 py-2.5 rounded-xl bg-slate-900 dark:bg-purple-600 text-xs font-bold text-white hover:bg-slate-800 dark:hover:bg-purple-500 transition-colors text-center cursor-pointer"
                                    >
                                        Manage Account
                                    </button>
                                </div>
