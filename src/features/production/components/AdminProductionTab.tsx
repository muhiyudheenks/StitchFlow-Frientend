...
export default function ProductionTab({ onOpenQuickAction }: ProductionTabProps) {
    const { data: batches = [], isLoading: isLoadingBatches, isError: isErrorBatches, error: batchesError } = useProductionBatches();
    ...
    return (
        <div className="space-y-6 font-sans">
            ...
            {isLoadingBatches ? (
                ...
                <div className="p-12 text-center text-rose-600 font-semibold bg-rose-50 rounded-3xl border border-rose-200">
